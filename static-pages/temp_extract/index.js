...
function generateDaySlots(date, busyTimes, settings = null) {
    ...
    if (userTimezone === 'America/New_York') {
        // Convert EST hours to UTC (add 5 hours)
        utcStartHour = daySchedule.start + 5;
        utcEndHour = daySchedule.end + 5;
    } else if (userTimezone === 'America/Los_Angeles') {
        // Convert PST hours to UTC (add 8 hours)
        utcStartHour = daySchedule.start + 8;
        utcEndHour = daySchedule.end + 8;
    }
